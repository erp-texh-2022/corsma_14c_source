...
In order for your contribution to Corsma to be accepted, you have to sign the
Corsma Contributor License Agreement (CLA). More information about this
...
3. An Corsma R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    ...
    If the name of the company is Corsma, the file would be
    `doc/cla/corporate/odoo.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the Corsma Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `groupecorsma.com`.  In that case someone from the Corsma team will
make the pull request on your behalf.

* Printable Corsma CCLA v1.0 https://www.groupecorsma.com/files/legal/Corsma-CCLA-v1.0.pdf
* Printable Corsma ICLA v1.0 https://www.groupecorsma.com/files/legal/Corsma-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for Corsma is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the Corsma project

* protect the Corsma project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the Corsma project and its users from bad actors who would contribute
...
contributor really intended to contribute to the Corsma project under specific
...
The Corsma CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, Corsma ERP to use, modify and
...
(ICLA) of Corsma.  The agreement is executed by adding your name and
...
removed from the Corsma project.
