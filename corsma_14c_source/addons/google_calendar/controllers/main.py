...
class GoogleCalendarController(http.Controller):
    ...
    def sync_data(self, model, **kw):
        """ This route/function is called when we want to synchronize Corsma
            ...
            The dictionary may contains an url, to allow Corsma Client to redirect user on
        ...
        if model == 'calendar.event':
            ...
            # Checking that user have already accepted Corsma to access his calendar !
