...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("CorsmaBeforeTestHook", "CorsmaAfterTestHook"); // Corsma customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("CorsmaBeforeTestHook"); // Corsma customization
  	...
  	finish: function finish() {
        ...
        emit("CorsmaAfterTestHook", this); // Corsma customization
