...
def fix_view_modes(action):
    """ For historical reasons, Corsma has weird dealings in relation to
...
class Session(http.Controller):
    ...
    def account(self):
        ...
        return 'https://accounts.groupecorsma.com/oauth2/auth?' + url_encode(params)
...
class ExportFormat(object):
    ...
    def from_data(self, fields, rows):
        """ Conversion method from Corsma's export data to whatever the
