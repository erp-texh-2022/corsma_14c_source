odoo.define('web.OwlCompatibility', function () {
    ...
    /**
     * This file defines the necessary tools for the transition phase where Corsma
     ...
     * adapter for Owl components that embed Corsma legacy widgets (or dynamically
     * both Owl components and Corsma legacy widgets), e.g.:
     *
     *                           Owl Component
     *                                 |
    ...
    class ComponentAdapter extends Component {
        ...
        /**
         * Mocks _trigger_up to redirect Corsma legacy events to OWL events.
         *
         * @private
         * @param {CorsmaEvent} ev
         */
        _trigger_up(ev) {
     ...
     * together when an Corsma legacy widget needs to instantiate Owl components.
    ...
    class ComponentWrapper extends Component {
         ...
         * Corsma legacy event. This function is called just before the event is
         * actually triggered.
         *
         * @private
         * @param {string} evType
