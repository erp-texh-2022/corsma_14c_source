...
class TestMailFullCommon(TestMassMailCommon, MassSMSCommon):
    ...
    def setUpClass(cls):
        ...
        cls.mailing_sms = cls.env['mailing.mailing'].with_user(cls.user_marketing).create({
            ...
            'body_plaintext': 'Dear ${object.display_name} this is a mass SMS with two links http://www.groupecorsma.com/smstest and http://www.groupecorsma.com/smstest/${object.id}',
            'sms_force_send': True,
