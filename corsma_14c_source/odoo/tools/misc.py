...
"""
Miscellaneous tools used by CorsmaERP.
"""
import cProfile
import collections
import datetime
...
def file_open(name, mode="r", subdir='addons', pathinfo=False, filter_ext=None):
    """Open a file from the CorsmaERP root, using a subdir folder.
    ...
    if os.path.isabs(name):
        ...
        for root in adps + [rtp]:
            ...
            # It is outside the CorsmaERP root: skip zipfile lookup.
...
def scan_languages():
    """ Returns all languages supported by CorsmaERP for translation
...
class UnquoteEvalContext(defaultdict):
    """Defaultdict-based evaluation context that returns
       ...
       the evaluation.
       Mostly useful for evaluating CorsmaERP domains/contexts that
