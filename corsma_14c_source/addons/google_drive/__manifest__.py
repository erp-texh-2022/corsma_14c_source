...

{
    ...
    'description': """
Integrate google document to Corsma record.
============================================

This module allows you to integrate google documents to any of your Corsma record quickly and easily using OAuth 2.0 for Installed Applications,
