 ...
 * everything concurrency related in Corsma.
 *
 * The basic concurrency primitives in Corsma JS are the callback, and the
...
return {
    ...
    /**
     * A (Corsma) mutex is a primitive for serializing computations.  This is
