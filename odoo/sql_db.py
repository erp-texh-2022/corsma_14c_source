...
"""
The PostgreSQL connector is a connectivity layer between the CorsmaERP code and
...
class Cursor(BaseCursor):
    """Represents an open transaction to the PostgreSQL DB backend,
       ...
       ``cursor`` objects.
        ...
        such as CorsmaERP, we need the best guarantees that no data
        ...
        CorsmaERP implements its own level of locking protection
        ...
        the default transaction isolation level for CorsmaERP cursors, as
