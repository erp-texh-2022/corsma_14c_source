...
var CrashManager = AbstractService.extend({
    ...
    rpc_error: function(error) {
        ...
        // Corsma custom exception: UserError, AccessError, ...
    ...
    show_error: function (error) {
        ...
        var dialog = new dialogClass(this, {
            title: _.str.capitalize(error.type) || _t("Corsma Error"),
        }, error);
...
var RedirectWarningHandler = Widget.extend(ExceptionHandler, {
    ...
    display: function() {
        ...
        new WarningDialog(this, {
            title: _.str.capitalize(error.type) || _t("Corsma Warning"),
            buttons: [
...
function session_expired(cm) {
    return {
        display: function () {
            const notif = {
                type: _t("Corsma Session Expired"),
                message: _t("Your Corsma session expired. The current page is about to be refreshed."),
            };
            const options = {
                buttons: [{
                    text: _t("Ok"),
