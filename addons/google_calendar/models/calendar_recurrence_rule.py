...
class RecurrenceRule(models.Model):
    ...
    def _write_from_google(self, gevent, vals):
        ...
        # event_tz is written on event in Google but on recurrence in Corsma
    ...
    def _create_from_google(self, gevents, vals_list):
        for gevent, vals in zip(gevents, vals_list):
            ...
            # If we convert a single event into a recurrency on Google, we should reuse this event on Corsma
