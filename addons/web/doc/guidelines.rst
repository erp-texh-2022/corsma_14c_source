...
example in CorsmaERP is dashboards), queries should be restricted to a
...
CorsmaERP Web's :js:class:`~openerp.web.Widget` has an attribute
...
From v11, we introduce a new coding standard for Corsma Javascript code.  Here it
is:
