...
term representation was ['=', 'company_id.name', 'CorsmaERP']. Used in a
...
CorsmaERP will use the SQL function 'unaccent' when available for the
...
Finally, to instruct CorsmaERP to really use the unaccent function, you have to
