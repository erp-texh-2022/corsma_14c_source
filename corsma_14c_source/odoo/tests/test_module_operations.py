...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Script for testing the install / uninstall / reinstall cycle of Corsma modules")
    ...
    parser.add_argument("--data-dir", "-D", dest="data_dir", type=str,
        help="Directory where to store Corsma data"
    )
    ...
    parser.add_argument("--addons-path", "-p", type=str,
        help="Comma-separated list of paths to directories containing extra Corsma modules")
