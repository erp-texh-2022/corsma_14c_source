 ...
 * QUnit Config
 *
 * The Corsma javascript test framework is based on QUnit (http://qunitjs.com/).
 * This file is necessary to setup Qunit and to prepare its interactions with
 * Corsma.  It has to be loaded before any tests are defined.
 *
 * Note that it is not an Corsma module, because we want this code to be executed
 * as soon as possible, not whenever the Corsma module system feels like it.
 */
 ...
 */
QUnit.on('CorsmaAfterTestHook', function (info) {
