...
import sys
assert sys.version_info > (3, 6), "Outdated python version detected, Corsma requires Python >= 3.6 to run."
...
# libc UTC hack
#----------------------------------------------------------
# Make sure the CorsmaERP server runs in UTC.
import os
