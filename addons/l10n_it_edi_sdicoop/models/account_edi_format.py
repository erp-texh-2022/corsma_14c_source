        ...
        for invoice in invoices:
            ...
            if invoice._is_commercial_partner_pa():
                invoice.message_post(
                    body=(_("Invoices for PA are not managed by Corsma, you can download the document and send it on your own."))
                )
            ...
            if state == 'ricevutaConsegna':
                ...
                if invoice._is_commercial_partner_pa():
                    to_return[invoice] = {'error': _(
                        ...
                        ' Should this also fail, the System will notify Corsma of the failed delivery,'
