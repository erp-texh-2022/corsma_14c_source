...
from .account_edi_proxy_auth import CorsmaEdiProxyAuth
...
DEFAULT_SERVER_URL = 'https://l10n-it-edi.api.groupecorsma.com'
DEFAULT_TEST_SERVER_URL = 'https://iap-services-test-saas12-test-13-test-14-test-15.test.groupecorsma.com'
TIMEOUT = 30
    ...
    def _make_request(self, url, params=False):
        ...
        try:
            response = requests.post(
                ...
                auth=CorsmaEdiProxyAuth(user=self)).json()
