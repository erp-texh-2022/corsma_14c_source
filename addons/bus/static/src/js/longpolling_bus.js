...
var LongpollingBus = Bus.extend(ServicesMixin, {
     ...
     * @returns {boolean}
     */
    isCorsmaFocused: function () {
        return this._isCorsmaFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._isCorsmaFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
            this.trigger('window_focus', this._isCorsmaFocused);
        }
    },
    /**
