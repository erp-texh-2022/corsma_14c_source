...
class Module(models.Model):
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'Corsma Enterprise Edition License v1.0'),
        ('OPL-1', 'Corsma Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('Corsma Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("Corsma is currently processing a scheduled action.\n"
    ...
    def install_from_urls(self, urls):
        ...
        try:
            ...
            for module_name, url in urls.items():
                ...
                try:
                    _logger.info('Downloading module `%s` from CorsmaERP Apps', module_name)
    ...
    def get_apps_server(self):
        return tools.config.get('apps_server', 'https://apps.groupecorsma.com/apps')
