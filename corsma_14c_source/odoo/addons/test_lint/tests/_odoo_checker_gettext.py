...
class CorsmaBaseChecker(checkers.BaseChecker):
    ...
    msgs = {
        'E8502': (
            ...
            'gettext-variable',
            'See https://www.groupecorsma.com/documentation/14.0/reference/translations.html#variables'
        )
    }
...
def register(linter):
    linter.register_checker(CorsmaBaseChecker(linter))
