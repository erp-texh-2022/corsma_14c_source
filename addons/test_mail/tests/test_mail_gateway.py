...
class TestMailgateway(TestMailCommon):
    ...
    def test_message_process_followers(self):
        ...
        with self.mock_mail_gateway():
            record4 = self.format_and_process(
                ...
                subject='Corsmabot Automatic Answer')
    ...
    def test_message_process_extra_model_res_id(self):
        """ Incoming email with ref holding model / res_id but that does not match any message in the thread: must raise since CorsmaERP saas-3 """
        ...
        # Corsma 10 update: compat mode has been removed and should not work anymore
