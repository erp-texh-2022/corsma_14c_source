...
/**
 * The purpose of this file is to add the support of Corsma actions of type
...
var WKHTMLTOPDF_MESSAGES = {
    ...
    workers: _lt('You need to start Corsma with at least two workers to print a pdf version of ' +
                 'the reports.'),
};
