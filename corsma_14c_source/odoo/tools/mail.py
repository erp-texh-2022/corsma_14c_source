...
def email_send(email_from, email_to, subject, body, email_cc=None, email_bcc=None, reply_to=False,
    ...
    :deprecate: since CorsmaERP 6.1, please use ir.mail_server.send_email() instead.
...
def encapsulate_email(old_email, new_email):
    ...
    * New From: notifications@groupecorsma.com
    * Output: "Admin" <notifications@groupecorsma.com>
    """
