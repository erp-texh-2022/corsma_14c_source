...
def standalone(*tags):
    ...
    ``tags`` and the corresponding Corsma module name.
    """
    def register(func):
...
# Main classes
# ------------------------------------------------------------
class CorsmaSuite(unittest.suite.TestSuite):
...
class BaseCase(TreeCase, MetaCase('DummyCase', (object,), {})):
    """
    Subclass of TestCase for common CorsmaERP-specific code.

    This class is abstract and expects self.registry, self.cr and self.uid to be
    initialized by subclasses.
    """

    longMessage = True      # more verbose error message by default: https://www.groupecorsma.com/r/Vmh
...
class ChromeBrowser():
    ...
    def _from_remoteobject(self, arg):
        ...
        # of the way Corsma widgets are created they all appear as Class(...)
