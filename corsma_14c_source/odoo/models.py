...
class BaseModel(MetaModel('DummyModel', (object,), {'_register': False})):
    """Base class for Corsma models.

    Corsma models are created by inheriting one of the following:
...
%(fields_list)s""") % {
    ...
    def _where_calc(self, domain, active_test=True):
        """Computes the WHERE clause needed to implement an CorsmaERP domain.
...
class Model(AbstractModel):
    """ Main super-class for regular database-persisted Corsma models.

    Corsma models are created by inheriting from this class::
