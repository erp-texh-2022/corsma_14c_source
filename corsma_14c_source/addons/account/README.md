...
The Corsma <a href="https://www.groupecorsma.com/page/accounting">Open Source Accounting</a> app allows a better way to
...
in one place. Corsma's user interface is designed with productivity in mind.
...
accounting; Corsma has all the features you need to sustain all your business
activities.

Scale With Your Organization
----------------------------

Corsma supports multiple currencies, multiple users with different access rights,
