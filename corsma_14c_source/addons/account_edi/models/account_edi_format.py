...
from odoo.tools.pdf import CorsmaPdfFileReader, CorsmaPdfFileWriter
...
class AccountEdiFormat(models.Model):
    ...
    def _create_invoice_from_pdf_reader(self, filename, reader):
        ...
        :param reader:   The CorsmaPdfFileReader of the pdf to import.
        :returns:        The created invoice.
        """
        # TO OVERRIDE
        self.ensure_one()
    ...
    def _embed_edis_to_pdf(self, pdf_content, invoice):
        ...
        if to_embed:
            ...
            reader = CorsmaPdfFileReader(reader_buffer, strict=False)
            writer = CorsmaPdfFileWriter()
    ...
    def _decode_pdf(self, filename, content):
        ...
        * pdf_reader:       The pdf_reader if type is pdf.
        ...
        try:
            ...
            pdf_reader = CorsmaPdfFileReader(buffer, strict=False)
        except Exception as e:
            # Malformed pdf
