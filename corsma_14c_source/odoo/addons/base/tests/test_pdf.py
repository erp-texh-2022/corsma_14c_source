...
class TestPdf(TransactionCase):
    ...
    def setUp(self):
        ...
        self.minimal_pdf_reader = pdf.CorsmaPdfFileReader(self.minimal_reader_buffer)
    ...
    def test_odoo_pdf_file_writer(self):
        ...
        pdf_writer = pdf.CorsmaPdfFileWriter()
        pdf_writer.cloneReaderDocumentRoot(self.minimal_pdf_reader)
    ...
    def test_odoo_pdf_file_reader_with_owner_encryption(self):
        ...
        with io.BytesIO(encrypted_content) as reader_buffer:
            pdf_reader = pdf.CorsmaPdfFileReader(reader_buffer)
    ...
    def test_merge_pdf(self):
        ...
        merged_pdf_reader = pdf.CorsmaPdfFileReader(merged_reader_buffer)
    ...
    def test_branded_file_writer(self):
        ...
        self.assertEqual(pdf_info['/Producer'], 'Corsma')
        self.assertEqual(pdf_info['/Creator'], 'Corsma')
        reader_buffer.close()
