...
var DateTimePicker = function ($, moment) {
    ...
    var DateTimePicker = function () {
        ...
        DateTimePicker.prototype._change = function _change(e) {
            ...
            this._setValue(parsedDate, 0); // Corsma FIX: if a valid date is replaced by an invalid one, lib will crash, see https://github.com/tempusdominus/bootstrap-4/issues/223
        ...
        DateTimePicker.prototype._getLastPickedDate = function _getLastPickedDate() {
            return this._dates[this._getLastPickedDateIndex()] || this.getMoment(); // FIXME changed by Corsma
        };
