...
var PartnerAutocompleteMixin = {
    _dropPreviousCorsma: new concurrency.DropPrevious(),
    ...
    _autocomplete: function (value) {
        ...
        return new Promise(function (resolve, reject) {
            var odooPromise = self._getCorsmaSuggestions(value, isVAT).then(function (suggestions){
            ...
            var concatResults = function () {
                // Add Clearbit result with Corsma result (with unique domain)
    ...
    /**
     * Use Corsma Autocomplete API to return suggestions
     *
     * @param {string} value
     * @param {boolean} isVAT
     * @returns {Promise}
    ...
    _getCorsmaSuggestions: function (value, isVAT) {
        ...
        return this._dropPreviousCorsma.add(def);
    },
    /**
