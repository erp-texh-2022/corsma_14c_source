...
DEFAULT_ENDPOINT = 'https://iap-services.groupecorsma.com'
...
class CRMRevealRule(models.Model):
    ...
    industry_tag_ids = fields.Many2many('crm.iap.lead.industry', string='Industries', help='Leave empty to always match. Corsma will not create lead if no match')
    ...
    def _create_lead_from_response(self, result):
        ...
        template_values.update({
            'flavor_text': _("Opportunity created by Corsma Lead Generation"),
