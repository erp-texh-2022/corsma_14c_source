...
class MassMailingList(models.Model):
    ...
    def action_merge(self, src_lists, archive):
        ...
        # A (id=4): yti@groupecorsma.com; yti@example.com
        # B (id=5): yti@groupecorsma.com; yti@groupecorsma.com
        # C (id=6): nothing
        ...
        # ------------+---------------------------+------------------------
        #           4 | yti@groupecorsma.com              |          1 |        4 |
        #           6 | yti@groupecorsma.com              |          2 |        5 |
        #           5 | yti@example.com           |          1 |        4 |
        #           7 | yti@groupecorsma.com           |          1 |        5 |
        #
