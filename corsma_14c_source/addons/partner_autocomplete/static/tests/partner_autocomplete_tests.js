odoo.define('partner_autocomplete.tests', function (require) {
    ...
    var suggestions = [{
        name: "Corsma",
        website: "groupecorsma.com",
        domain: "groupecorsma.com",
        logo: "groupecorsma.com/logo.png",
        vat: "BE0477472701"
    }];
            ...
            _.each(fieldsToPatch, function (fieldToPatch) {
                testUtils.mock.patch(fieldToPatch, {
                    _getBase64Image: function (url) {
                        return Promise.resolve(url === "groupecorsma.com/logo.png" ? "odoobase64" : "");
                    },
                    _isOnline: function () {
                        return true;
                    },
                    ...
                    _getCorsmaSuggestions: function (value, isVAT) {
                    ...
                    _getClearbitSuggestions: function (value) {
                        return this._getCorsmaSuggestions(value);
                    },
        ...
        var form = await createView({
            ...
            mockRPC: function (route) {
                if (route === "/web/static/src/img/placeholder.png"
                    || route === "groupecorsma.com/logo.png"
            ...
            assert.strictEqual($input.val(), "Corsma", "Input value should have been updated to \"Corsma\"");
            assert.strictEqual(form.$("input.o_field_widget").val(), "groupecorsma.com", "website value should have been updated to \"groupecorsma.com\"");
