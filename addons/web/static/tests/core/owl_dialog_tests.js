odoo.define('web.owl_dialog_tests', function (require) {
    ...
    QUnit.module('core', {}, function () {
        ...
        QUnit.test("Rendering of all props", async function (assert) {
            ...
            assert.containsNone(document.body, '.modal-backdrop'); // No backdrop *element* for Corsma modal...
            ...
            // Title (default: 'Corsma')
            assert.strictEqual(dialog.querySelector('h4.modal-title').innerText.trim(), "Corsma" + "The Subtitle",
