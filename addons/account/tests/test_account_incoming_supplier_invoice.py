...
class TestAccountIncomingSupplierInvoice(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.env['ir.config_parameter'].sudo().set_param('mail.catchall.domain', 'test-company.groupecorsma.com')

        cls.internal_user = cls.env['res.users'].create({
            'name': 'Internal User',
            'login': 'internal.user@test.groupecorsma.com',
            'email': 'internal.user@test.groupecorsma.com',
        })
